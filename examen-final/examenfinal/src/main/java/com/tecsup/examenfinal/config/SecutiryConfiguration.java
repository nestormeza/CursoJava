package com.tecsup.examenfinal.config;


import com.tecsup.examenfinal.jwt.JwtAuthenticationFilter;
        ...
        http.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(
                    auth->auth
                            ...
                            .requestMatchers(Constants.ENDPOINTS_SUPERADMIN).hasAnyAuthority(Role.SUPERADMIN.name())
                            //Otros Permisos
